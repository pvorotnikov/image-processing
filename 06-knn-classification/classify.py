...
import os, sys, math, logging, collections, argparse
import numpy as np
...
def main():
    ...
    logging.info('============================')
    logging.info('Image classified as {0}'.format(classified_label))
    logging.info('Nearest neighbor at {0}'.format(dist[0][0]))
